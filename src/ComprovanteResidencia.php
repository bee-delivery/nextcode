...
class ComprovanteResidencia
{
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file-url/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file-form/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file-url-form/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/proof-of-residence/single-file-base64-form/', ['json' => $data]);
    }
