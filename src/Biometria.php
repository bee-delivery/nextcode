...
class Biometria
{
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/face-compare/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/face-compare-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/face-compare-url/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/new-face-compare/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/new-face-compare-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/new-face-compare-url/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/compare-datavalid/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/compare-datavalid-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('https://id.nxcd.com.br/v1.0/bio/compare-datavalid-url/', ['json' => $data]);
    }
}
