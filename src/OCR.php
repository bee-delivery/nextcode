...
class OCR
{
    ...
    {
        return $this->http->post('v1.0/id/extract-all-single-file/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/id/extract-all-single-file-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/id/extract-all-single-file-url/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/id/extract-all-two-files/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/id/extract-all-two-files-base64/', ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/id/extract-all-two-files-url/', ['json' => $data]);
    }
