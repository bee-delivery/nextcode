...
class Classificacao
{
    ...
    {
        return $this->http->post('v1.0/classifier/single-file/' , ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/classifier/single-file-base64/' , ['json' => $data]);
    }
    ...
    {
        return $this->http->post('v1.0/classifier/single-file-url/' , ['json' => $data]);
    }
